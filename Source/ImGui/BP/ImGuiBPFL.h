...
/* Widgets / Input with Keyboard */
	...
	UFUNCTION(BlueprintCallable, Category="DearImGui/! Raw C++ Functions")//, BlueprintInternalUseOnly)
	static UPARAM(DisplayName = "bCallback") bool InputTextBox(FString Label, FString Hint, UPARAM(ref) FString& InputedString, int MaxCharactersCount, FVector2D BoxSize, UPARAM(meta = (Bitmask, BitmaskEnum = "EImGuiInputTextFlags")) int InputTextFlagsBitmask);
